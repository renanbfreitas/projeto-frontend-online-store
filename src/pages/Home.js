...
class Home extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <p data-testid="home-initial-message" className="msgTelaSuperior">
          Digite algum termo de pesquisa ou escolha uma categoria.
        </p>
        <div>
          <Link to="/cart" data-testid="shopping-cart-button">
            <button
              className="buttonCarrinhoDeCompras"
              type="button"
            >
              Carrinho de Compras
        ...
        {!resultado ? 'Nenhum produto foi encontrado' : (
          result.map((item) => (
            ...
            >
              ...
              <button type="button" className="buttonMaisDetalhes">
                <Link
              ...
              <button
                className="buttonCarrinhoDeCompras2"
